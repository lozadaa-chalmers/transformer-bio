...
cell_embeddings_anndata.obs['batch'] = our_data.obs['batch']
cell_embeddings_anndata.obs['louvain'] = our_data.obs['louvain']
fig = sc.pl.umap(
...
fig.savefig(
    f"random_cell_embeddings_umap-test-alc-pancreas-4.png",
    bbox_inches="tight",
)
